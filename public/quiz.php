    ...
    <div class="mx-auto max-w-lg mt-20">
        ...
        <from method="POST" action="">
            <div class="grid lg:grid-cols-2 gap-2 md:gap-4 mt-10">
                    ...
                    <label for="option1" class="w-full h-20 bg-black rounded-lg p-4 flex inline-flex items-center"">
                    ...
                    <label class="w-full h-20 bg-black rounded-lg p-4 flex inline-flex items-center" for="option2">
