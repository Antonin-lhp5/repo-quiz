<div class="bg-gray-700 p-5 ring-green-600 ring-2 shadow">
    <div>
        ...
        <input class="w-full p-2 mb-6 text-gray-400 bg-gray-800 focus:border-transparent" type="text" name="titleQuiz" id="titleQuiz" value="<?= $detailsQuizArray['qTitle']  ?? (isset($_POST['qTitle']) ? htmlspecialchars($_POST['qTitle']) : '')?>">
    </div>
    <div>
