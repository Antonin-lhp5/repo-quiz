...
<div class="bg-gray-700 p-5 mt-5 ring-black ring-2 ring-opacity-10 shadow">
    <p>Questions <span><?= $totalQuestions ?>/10</span></p>
    <?php foreach ($detailsQuestionAndAnswerArray as $details) { ?>
        <div class="bg-gray-800 p-4 my-2 rounded-md flex-col">
