...
<div class="modal h-screen w-full fixed left-0 top-0 justify-center items-center bg-black bg-opacity-50 hidden">
    ...
    <div class="bg-black rounded shadow-lg w-1/3">
        ...
        <div id="nameQuiz" class="p-3">
            <p> Voulez-vous vraiment supprimer cette question ? Attention, cette action est irréversible !</p>
        </div>
        <div class="flex justify-end items-center w-100 border-t p-3">
            <form action="" method="POST">
                <button id="deleteBtnModal" name="deleteBtn" type="submit" value="<?= $questionInfoArray['id_question'] ?>" class="bg-red-600 hover:bg-red-700 px-3 py-1 rounded text-white mr-2">Supprimer</button>
            </form>
