<div class="bg-gray-800 shadow-lg h-16">
  <div class="container mx-auto max-w-screen-xl">
    <nav class="flex justify-between items-center pb-3 sm:pb-0 pt-5 px-4 lg:px-0">
      <div class="text-light tracking-wide space-x-4 hidden sm:flex justify-center">
      ...
      <div class="flex">
        ...
        <div class="text-red-400">
          <button class="flex underline">
            Déconnexion 
            <span><svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
            </svg></span>
          </button>
