  ...
  <div class="max-w-6xl mx-auto px-4">
    <div class="flex justify-between">
      ...
      <div class="hidden md:flex items-center">
        ...
        <a href="" class="transition duration-300 ease-in-out focus:outline-none focus:shadow-outline bg-purple-700 hover:bg-purple-900 text-white font-normal py-2 px-4 rounded">Créer</a>
        <a href="" class="py-2 px-3 bg-red-700 hover:bg-red-800 rounded transition duration-300 ml-6">Se déconnecter</a>
      </div>
