<footer class="bg-gray-900 pt-5 lg:pt-12">
    <div class="container mx-auto max-w-screen-xl px-5 md:px-0 pb-5">
        <div class="flex flex-wrap md:flex-nowrap">
            ...
            <div class="w-full md:w-1/2 bg-pink-600 p-5 flex flex-col items-center justify-center">
                <div class="flex items-center justify-center mb-2">
                    <h2 class="text-base sm:text-lg font-title">Suivez-nous</h2>
                    <svg class="w-6 h-6 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                    </svg>
                </div>

                <div class="flex justify-center text-gray-200 space-x-2">
                    <div>
