		...
		<form action="library.php" method="GET">
			<table class="w-full divide-y divide-gray-200">
				<thead class="bg-purple-900">
					<tr>
						<th class="px-2 py-3 text-left  font-medium text-gray-200 uppercase tracking-wider">Image</th>
						<th class="px-2 py-3 text-left  font-medium text-gray-200 uppercase tracking-wider">Nom du quiz</th>
						<th class="px-2 py-3 text-left  font-medium text-gray-200 uppercase tracking-wider">Catégorie</th>
						<th class="px-2 py-3 text-left  font-medium text-gray-200 uppercase tracking-wider">Action</th>
					</tr>
				</thead>
